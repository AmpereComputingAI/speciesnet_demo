...
Run with
```bash
docker run -p 8000:8000 ghcr.io/amperecomputingai/speciesnet_demo:1.3
```
...
```bash
docker run -p 4321:8000 -e SKIP_FRAMES=11 ghcr.io/amperecomputingai/speciesnet_demo:1.3
```
